...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPENP = 9,                      /* OPENP  */
  YYSYMBOL_CLOSEP = 10,                    /* CLOSEP  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "ERROR",
  "EOL", "PLUS", "MINUS", "TIMES", "OPENP", "CLOSEP", "$accept", "program",
...
{
       1,    10,    11,    14,    15,    13,     2,     9,    10,    11,
       8,    12,    16,     7
};

static const yytype_int8 yycheck[] =
{
       3,     6,     7,    10,    11,    10,     9,     5,     6,     7,
       0,     8,    12,     2
};
